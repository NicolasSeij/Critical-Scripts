        ...
        for a = 1, #SecurityCamConfig.Locations do
            ...
            if pedAllowed then
                if distance <= 5.0 then
                    ...
                    Draw3DText(box_x, box_y, box_z, tostring("~o~[E]~w~ Usar " .. box_label .. " Camara"))
...
function CreateInstuctionScaleform(scaleform)
    ...
    InstructionButtonMessage("Siguiente camara")
    PopScaleformMovieFunctionVoid()

    PushScaleformMovieFunction(scaleform, "SET_DATA_SLOT")
    PushScaleformMovieFunctionParameterInt(1)
    InstructionButton(GetControlInstructionalButton(1, 194, true))
    InstructionButtonMessage("Cerrar camara")
    PopScaleformMovieFunctionVoid()

    PushScaleformMovieFunction(scaleform, "SET_DATA_SLOT")
    PushScaleformMovieFunctionParameterInt(2)
    InstructionButton(GetControlInstructionalButton(1, 174, true))
    InstructionButtonMessage("Salir")
    PopScaleformMovieFunctionVoid()
