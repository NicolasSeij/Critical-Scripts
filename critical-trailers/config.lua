...
AddTextEntry('VEH_E_DETATCH', 'Preciona ~INPUT_VEH_HORN~ Desenganchar el Vehiculo')        -- Text for external detach point
AddTextEntry('VEH_I_AORD', 'Preciona ~INPUT_VEH_HORN~ Para Enganchar/Desenganchar El Vehiculo')   -- Text for in boat attach/detach
AddTextEntry('VEH_I_RAMP', 'Preciona ~INPUT_VEH_HORN~ Para Subir/Bajar La Rampa')   -- Text for in boat attach/detach
